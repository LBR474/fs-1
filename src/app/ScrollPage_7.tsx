...
function wrapForward(trigger: globalThis.ScrollTrigger) {
...
function wrapBackward(trigger: globalThis.ScrollTrigger) {
...
function buildSeamlessLoop(items: any[], spacing: number) {
  ...
  return (
      ...
      <div className={`${styles.gallery} gallery`}>
        ...
        <ul className={`${styles.cards} cards`}>
